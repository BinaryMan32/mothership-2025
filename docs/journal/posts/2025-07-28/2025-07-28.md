...
![2nd LT Lang's body in Greta Base Pantry](./greta-base-pantry-body.png)
/// caption
2nd LT Lang's body in [Greta Base](greta-base.md) Pantry
///

- body with cuts all over
    - tags say 2nd LT Lang
...
- [Ink](ink.md) asks about Hintin
    - [Dr. Edem](dr-edem.md): we don't know what happened to Hintin
    - [Sergeant Valdez](valdez.md): Hintin and Jensen went to check on the reactor
...
- [Carnoc](carnoc-ashbrow.md) shows Lang's tags to [Sergeant Valdez](valdez.md)
...
- [Carnoc](carnoc-ashbrow.md) asks for spare battle dress
    - [Sergeant Valdez](valdez.md) will loan one if we check on Hintin and Jensen
...
- [Sergeant Valdez](valdez.md) will have engineer Sobel fix up the APC
...
1. Go to the reactor to find out what happened to Hintin and Jensen
    - if the reactor stops working, the dam will fail and the [Carcs](carcinids.md) will get us
