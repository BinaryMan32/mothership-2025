...
- prepare to travel back to [Prospero's Dream](index.md)
- there are only 5 cryo pods
    - Hank, [Noriko](noriko.md), [Ink](ink.md), Blink, [Dex](dex-miro.md), [Zeke](zeke-sinclair.md), [Carnoc](carnoc-ashbrow.md)
    - we rotate 2 out while the other 5 sleep
    - one month rotations
    - trip will take almost 2 years
    - order: [Ink](ink.md), [Murderbot](murderbot-v2.md), [Carnoc](carnoc-ashbrow.md), [Zeke](zeke-sinclair.md), [Dex](dex-miro.md), [Noriko](noriko.md)
