...
After [Ink](ink.md) and [Murderbot](murderbot-v2.md) disarm the warhead, [Murderbot](murderbot-v2.md) discovers there was no real threat since Monarch could have stopped it at any time.
[Murderbot](murderbot-v2.md) (possibly) removes Monarch's access to the warned.
One of the Toms returns from [Ink](ink.md)'s mission terrified, describing a spider tank that's big enough to "hold 4 Steves".
[Dex](dex-miro.md) leaves an android corpse to test the spider tank, which it quickly obliterates.
Attempts to trigger radios to notify [Kilroy](rachael-kilroy.md) reveal they were already activated.
The crew find a massive cube of infiltrator androids, which they scatter to delay the spider tank.
In the [53C Micro Hangar](#53c-micro-hangar), [Murderbot](murderbot-v2.md) hacks the micro-craft while [Dex](dex-miro.md) and [Ink](ink.md) don power loaders.
[Dex](dex-miro.md) takes out all of the spider tank's legs on one side with a single swing of the **Turbo Sledge**.
[Dex](dex-miro.md) and [Ink](ink.md) guide it on a space tour.
Many of the androids left in the micro-craft, and all were shot down except a single Ellen.
[Murderbot](murderbot-v2.md) partially unlocks the [51E Anti-Organic Armory](#51e-anti-organic-armory) weapons and the crew stock up on weapons, ammo, and explosives.
The crew hears the conclusion of a firefight, and then encounter the team of troubleshooters involved.
[Kilroy](rachael-kilroy.md) appears and demands the crew prove they work for her.
